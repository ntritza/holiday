...
Developer-friendly & type-safe Typescript SDK specifically catered to leverage *holiday* API.

<div align="left">
    <a href="https://www.speakeasy.com/?utm_source=holiday&utm_campaign=typescript"><img src="https://custom-icon-badges.demolab.com/badge/-Built%20By%20Speakeasy-212015?style=for-the-badge&logoColor=FBE331&logo=speakeasy&labelColor=545454" /></a>
...
```sh
npx -y --package holiday-test-sdk -- mcp start --help
```
...
* [readRootGet](docs/sdks/general/README.md#readrootget) - Read Root
...
const sdk = new Holiday({ httpClient });
```
...
You can also enable a default debug logger by setting an environment variable `HOLIDAY_DEBUG` to true.
<!-- End Debugging [debug] -->
...
### SDK Created by [Speakeasy](https://www.speakeasy.com/?utm_source=holiday&utm_campaign=typescript)
